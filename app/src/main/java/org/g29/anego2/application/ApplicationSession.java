...
import org.g29.anego2.application.ar.ImageTargets;

public class ApplicationSession implements UpdateCallbackInterface
{

    private static final String LOGTAG = "Anego_Applications";
    ...
    {
        AnegoException vuforiaException = null;
        mActivity = activity;
        ...
        if (mInitVuforiaTask != null)
        {
            ...
            vuforiaException = new AnegoException(
                    AnegoException.VUFORIA_ALREADY_INITIALIZATED,
                logMessage);
        ...
        if (vuforiaException == null)
        {
            ...
            } catch (Exception e)
            {
                ...
                vuforiaException = new AnegoException(
                    AnegoException.INITIALIZATION_FAILURE,
                    logMessage);
                Log.e(LOGTAG, logMessage);
            }
        }
    ...
    public void startAR(int camera) throws AnegoException
    {
        String error;
        if(mCameraRunning)
        {
        	...
        	Log.e(LOGTAG, error);
            throw new AnegoException(
                AnegoException.CAMERA_INITIALIZATION_FAILURE, error);
        }
    ...
    public void stopAR() throws AnegoException
    {
        ...
        synchronized (mShutdownLock)
        {
            ...
            if (!unloadTrackersResult)
                throw new AnegoException(
                    AnegoException.UNLOADING_TRACKERS_FAILURE,
                    "Failed to unload trackers\' data");
            
            if (!deinitTrackersResult)
                throw new AnegoException(
                    AnegoException.TRACKERS_DEINITIALIZATION_FAILURE,
    ...
    public void resumeAR() throws AnegoException
    {
    ...
    public void pauseAR() throws AnegoException
    {
        if (mStarted)
        {
            stopCamera();
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mShutdownLock)
            {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags, "");
            ...
            if (result)
            {
                ...
                if (initTrackersResult)
                {
                    ...
                    } catch (Exception e)
                    {
                        ...
                        vuforiaException = new AnegoException(
                            AnegoException.LOADING_TRACKERS_FAILURE,
                            logMessage);
                        Log.e(LOGTAG, logMessage);
                        mSessionControl.onInitARDone(vuforiaException);
                    }
                ...
                {
                    vuforiaException = new AnegoException(
                        AnegoException.TRACKERS_INITIALIZATION_FAILURE,
    ...
    private void configureVideoBackground()
    {
        ...
        VideoMode vm = cameraDevice.getVideoMode(CameraDevice.MODE.MODE_OPTIMIZE_QUALITY);
